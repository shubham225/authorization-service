    ...
    public SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http)
        ...
        http
                .authorizeHttpRequests((authorize) -> authorize
                        ...
                        .requestMatchers("/api/V1/roles/**").hasAnyAuthority("SCOPE_profile", "ROLE_admin")
                        .requestMatchers("/api/V1/users/**").hasAnyAuthority("SCOPE_profile", "ROLE_admin")
                        .requestMatchers("/api/V1/scopes/**").hasAnyAuthority("SCOPE_profile", "ROLE_admin")
                        .requestMatchers("/api/V1/clients/**").hasAnyAuthority("SCOPE_client.read", "ROLE_admin")
